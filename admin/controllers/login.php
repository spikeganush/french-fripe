<?php
    ...
    global $is_active, $wrongPwdErr, $accountNotExistErr, $emailPwdErr, $verificationRequiredErr, $email_empty_err, $pass_empty_err;
            ...
            if($rowCount <= 0) {
                ...
                if($is_active == '1') {
                    ...
                    $verificationRequiredErr = '<div class="alert alert-danger">
                            Your account is not active you can\'t access this area.
                        </div>';
                }
