...
$GLOBALS['path'] = $passing_value ;
$GLOBALS['directory'] = '../'.$GLOBALS['path'].'';
                ...
                <div class="col__right">
                    ...
                    <div class="row">
                        ...
                        <div class="product_title">
                            ...
                            <a href="edit_product_info.php?id=<?php echo$product_id;?>" <h3>Edit information</h3></a>
                        </div>
                    </div>
                    <!--/.First row-->
                    ...
                    <div class="row">
                        <!-- <h3>Add photos</h3> -->
                        <?php 
                       include("upload_script_edit.php"); 
                       ?>
                    </div>
                    <!--/.Second row-->
